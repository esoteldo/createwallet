import { TonClient, internal, toNano, comment, WalletContractV4 } from '@ton/ton';
...
const queryId = HighloadQueryId.fromSeqno(BigInt(28))// Use a specific seqno
